...
const msgpackTypes = [ 'msgpack', 'application/msgpack', 'application/*+msgpack' ];
...
module.exports = async function(req, opts) {
  ...
  // msgpack
  const msgpackType = opts.msgpackTypes || msgpackTypes;
  if (typeis(req, msgpackType)) return msgpack(req, opts);
